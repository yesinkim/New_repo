...
def bleu_score(reference: str, output: str, n: Optional[int]=4, use_BP: bool=True) -> float:
    ...
    return min(1, (len(output_tokens) / len(refer_tokens))) * (precision ** (1 / gram_num)) * bp
